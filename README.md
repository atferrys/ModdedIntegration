...
A simple Minecraft Plugin to auto-populate the [EssentialsX](https://www.spigotmc.org/resources/essentialsx.9089/)'s [items.csv file](https://github.com/EssentialsX/Essentials/blob/2.x/Essentials/src/main/resources/items.csv) with [Forge](http://files.minecraftforge.net/) items and blocks.
# ✅ Requirements
